        ...
        <main className="px-8 md:px-12 lg:px-20 py-8 text-lg responsive-font">
          <div className="flex justify-center">
            <div className="flex flex-col gap-8">
              ...
              <p>
                Movidos pelo desejo de criar um impacto significativo e
                mensurável nas comunidades, nos concentramos em criar esse
                projeto e nos esforçamos para conectar voluntários com projetos
                e organizações que tenham um impacto tangível e positivo na
                sociedade. Assim promovendo mais ações sociais e{" "}
          ...
          <div className="flex my-12 rounded-md gap-12 flex-col md:flex-row">
            <div className="flex-1 rounded-2xl bg-custom-black ">
              ...
              <p className="flex flex-col space-y-2 p-6 text-white">
                <p>
                  - Ongs podem se cadastrar para publicar vagas para
                  voluntários.
                </p>
          ...
          <div className="md:grid flex flex-col md:grid-cols-2 gap-12">
            <div className="">
              ...
              <span className="text-justify">
                Conectar voluntários com oportunidades significativas para
                causar um impacto positivo em suas comunidades. Nosso objetivo é
                fornecer uma plataforma amigável que facilite o registro e o
                engajamento de voluntários, ajudando-os a encontrar e contribuir
                para as causas pelas quais são apaixonados.
              </span>
            </div>
            <div className="">
              <p className="text-3xl font-bold text-custom-green">Visão</p>
              <span className="text-justify">
                Tornar-se o site de referência para voluntários que buscam fazer
                a diferença. Ser a principal plataforma que conecta voluntários
                com diversas organizações e projetos, proporcionando uma
                experiência perfeita e confiável para voluntários e
                organizações. Para que assim tenham o poder de criar mudanças
